...
import { Share2, Copy, Facebook, Twitter, Link2 } from 'lucide-react';
...
const ShareTimeline: React.FC<ShareTimelineProps> = ({ scandals, contextualFilter }) => {
  ...
  const stats = {
    ...
    mostAffectedParty: (() => {
      ...
      if (Object.keys(byParty).length === 0) return null;
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 p-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors"
                >
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 p-3 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors"
                >
