...
export var shareUtils = {
    ...
    generateShareTitle: function (contextualFilter) {
        ...
        switch (contextualFilter.type) {
            case 'personality':
                return "Skandalz de ".concat(contextualFilter.value);
            case 'party':
                return "Skandalz du ".concat(contextualFilter.value);
            case 'status':
                ...
                return "Skandalz des affaires ".concat(statusText);
            case 'scandalType':
                ...
                return "Skandalz des affaires ".concat(typeText);
            default:
                return 'Skandalz : La bibliothèque aux scandales';
        }
    },
