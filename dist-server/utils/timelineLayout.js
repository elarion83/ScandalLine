...
export var MIN_VERTICAL_SPACING = 40;
export var MIN_HORIZONTAL_SPACING = 40;
...
export var findNearestYearMarker = function (scrollPosition, viewportWidth, yearMarkers) {
    ...
    var markersToLeft = yearMarkers.filter(function (marker) { return marker.x <= centerPosition; });
    if (markersToLeft.length > 0) {
        ...
        var firstMarkerToRight = yearMarkers[0];
