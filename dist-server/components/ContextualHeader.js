...
const ContextualHeader = ({ contextualFilter, filteredCount, totalMoney, filteredScandals, onBack, shouldUseAdaptiveLayout, startYear, endYear, containerRef }) => {
    ...
    return (<div className="texture-overlay bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4 border-b border-gray-700">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button onClick={onBack} className="flex items-center gap-2 px-3 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors group">
